...
const BOTNAME = 'BLUEZ|-TECH-BOT™';
const FOOTERNAME = '> ＶＡＪＩＲＡ -  ＭＤ - Ｖ4';
global.owner = process.env.OWNER_NUMBER  || '776411684' ;  // 
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=WJlSibTD#Mk-H90p6rM5rXGBMXfVJINfwDzK17oti12nQ7tbAKqg id' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "776411684" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'BLUEZ TECh' ,
